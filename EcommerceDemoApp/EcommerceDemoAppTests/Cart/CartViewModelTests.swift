...
final class CartViewModelTests: XCTestCase {
    ...
    func testInitialState() {
        XCTAssertTrue(viewModel.cartProduct.isEmpty)
    ...
    func testTotalCartPrice() {
        ...
        let product2 = CartProductModel(id: 2, title: "Product 2", description: "Description 2", category: "Category 2", image: "image 2", price: 100.0, quantity: 1, rating: Rating(rate: 4.0, count: 1))
        viewModel.cartProduct.append(product1)
        viewModel.cartProduct.append(product2)
    ...
    func testRemoveProduct() {
        ...
        viewModel.cartProduct.append(product)
        XCTAssertEqual(viewModel.cartProduct.count, 1)
